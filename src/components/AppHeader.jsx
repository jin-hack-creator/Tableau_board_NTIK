  ...
  return (
    <header style={{
      ...
      <div style={{display:'flex',alignItems:'center',gap:16,marginLeft:32}}>
        <div style={{width:40,height:40,borderRadius:'50%',background:'#3b82f6',display:'flex',alignItems:'center',justifyContent:'center',color:'#fff',fontWeight:900,fontSize:22,boxShadow:'0 2px 8px #3b82f622'}}>N</div>
